...
pacman -S grub efibootmgr lvm2 networkmanager network-manager-applet dialog wpa_supplicant mtools dosfstools reflector base-devel linux-headers avahi xdg-user-dirs xdg-utils gvfs gvfs-smb nfs-utils inetutils dnsutils bluez bluez-utils cups hplip alsa-utils bash-completion openssh rsync reflector acpi acpi_call virt-manager qemu-full edk2-ovmf bridge-utils dnsmasq dmidecode vde2 openbsd-netcat iptables-nft ipset firewalld flatpak sof-firmware nss-mdns acpid os-prober ntfs-3g exfatprogs terminus-font zip unzip unrar p7zip htop man-db man-pages pacman-contrib fwupd pipewire pipewire-alsa pipewire-pulse pipewire-jack tlp vnstat ncdu iwd fdupes tree lsof
